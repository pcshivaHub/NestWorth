...
export default function AccountDetailScreen({ route, navigation }) {
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      ...
      <Button
        title={deleting ? 'Deleting...' : '🗑️  Delete Account'}
        variant="outline"
...
const styles = StyleSheet.create({
  ...
  heroAmount: { color: COLORS.textPrimary, fontSize: FONTS.sizes.hero, fontWeight: '800', marginVertical: SPACING.sm },
  row: { flexDirection: 'row' },
  typePill: {
    backgroundColor: COLORS.surfaceHigh, borderRadius: RADIUS.full,
    paddingHorizontal: SPACING.md, paddingVertical: 4,
  },
  typeText: { color: COLORS.textSecondary, fontSize: FONTS.sizes.sm },
